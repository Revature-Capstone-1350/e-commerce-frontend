...
const theme = "day";
let card_red,card_green,card_blue:number;

// Conditional code for themes
if (theme === "day") {
  card_red = 135;
  card_green = 206;
  card_blue = 235;
...
export const ProductCard = (props: productProps) => { // CODE STARTS HERE
  ...
  return (
    <Container onClick={() => {props.setSelection(props.product)}} 
      style={{
        backgroundColor:"rgba(card_red,card_green,card_blue,0.8)"
      }}>
      {/* <Circle /> */}
      <Image src={props.product.image_url_s} style={{opacity:"1"}}/>
      <Info>
        <Icon>
